          ...
          <div className="Contenedor-stats-pk">
            <div className="Tipo-pokemon">
              <ul className="Tipo-pokemon-lista" style={{ color: "white" }}>
                <span className={`parrafo-tipo ${pokemon.tipo[0]}`}>
                  {pokemon.tipo[0]}
                </span>
                {pokemon.tipo[1] ? (
                  <span className={`parrafo-tipo ${pokemon.tipo[1]}`}>
                    {pokemon.tipo[1]}
                  </span>
                ) : null}
              </ul>
            ...
            <div className="Peso-altura-movimientos">
              ...
              <div className="atributos-pokemon">
                ...
                <div className="div-moves">
                  <p
                    style={{ color: "#212121" }}
                    className={`parrafo-moves ${pokemon.about.moves[0]}`}
                  >
                    {pokemon.about.moves[0]}
                  </p>
                  <p
                    style={{ color: "#212121" }}
                    className={`parrafo-moves ${pokemon.about.moves[1]}`}
                  >
            ...
            <div className="base-stats">
              <h2
                className={`texto-base-stats ${pokemon.tipo}`}
                style={{ background: "whitesmoke" }}
              >
                Base Stats
              </h2>
